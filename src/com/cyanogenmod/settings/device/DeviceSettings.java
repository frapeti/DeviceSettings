...
public class DeviceSettings extends FragmentActivity {
    ...
    public static final String SHARED_PREFERENCES_BASENAME = "com.frapeti.test";
    public static final String ACTION_UPDATE_PREFERENCES = "com.frapeti.test.UPDATE";
